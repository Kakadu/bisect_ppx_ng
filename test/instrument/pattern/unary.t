Alias.
  ...
  | `A as _x -> (___bisect_visit___ 1; ())
  | `B as _x -> (___bisect_visit___ 2; ())
  | _ -> ()))
...
Constructor.
  ...
  ((((match ___bisect_matched_value___ with
  | Some `A -> (___bisect_visit___ 1; ())
  | Some `B -> (___bisect_visit___ 2; ())
  | _ -> ()))
  [@ocaml.warning "-4-8-9-11-26-27-28-33"]);
  ___bisect_post_visit___ 0 (print_endline "foo"))
  | None -> (___bisect_visit___ 3; ())
...
Polymorphic variant constructor.
  ...
  ((((match ___bisect_matched_value___ with
  | `A `B -> (___bisect_visit___ 1; ())
  | `A `C -> (___bisect_visit___ 2; ())
  | _ -> ()))
  [@ocaml.warning "-4-8-9-11-26-27-28-33"]);
  ___bisect_post_visit___ 0 (print_endline "foo"))
...
Type constraint.
  ...
  ((((match ___bisect_matched_value___ with
  | (`A : _) -> (___bisect_visit___ 1; ())
  | (`B : _) -> (___bisect_visit___ 2; ())
  | _ -> ()))
  [@ocaml.warning "-4-8-9-11-26-27-28-33"]);
  ___bisect_post_visit___ 0 (print_endline "foo"))
...
Lazy.
  ...
  > EOF
  let _ =
  match lazy (___bisect_visit___ 3; `A) with
  | (lazy (`A | `B)) as ___bisect_matched_value___ ->
  ((((match ___bisect_matched_value___ with
  | (lazy `A) -> (___bisect_visit___ 1; ())
  | (lazy `B) -> (___bisect_visit___ 2; ())
  | _ -> ()))
  [@ocaml.warning "-4-8-9-11-26-27-28-33"]);
  ___bisect_post_visit___ 0 (print_endline "foo"))
