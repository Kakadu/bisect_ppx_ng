...
Subexpressions are still instrumented.
  ...
  let _ =
  (___bisect_post_visit___ 16 (List.length [])) mod
  (___bisect_post_visit___ 17 (List.length []))
  let _ =
  (___bisect_post_visit___ 18 (List.length [])) mod
  (___bisect_post_visit___ 19 (List.length []))
  let _ =
  ...
  > EOF
  let _ =
  (___bisect_post_visit___ 0 (List.length [])) land
  (___bisect_post_visit___ 1 (List.length []))
  let _ =
  (___bisect_post_visit___ 2 (List.length [])) land
  (___bisect_post_visit___ 3 (List.length []))
  let _ =
  (___bisect_post_visit___ 4 (List.length [])) lor
  (___bisect_post_visit___ 5 (List.length []))
  let _ =
  (___bisect_post_visit___ 6 (List.length [])) lor
  (___bisect_post_visit___ 7 (List.length []))
  let _ =
  (___bisect_post_visit___ 8 (List.length [])) lxor
  (___bisect_post_visit___ 9 (List.length []))
  let _ =
  (___bisect_post_visit___ 10 (List.length [])) lxor
  (___bisect_post_visit___ 11 (List.length []))
  let _ =
  (___bisect_post_visit___ 12 (List.length [])) lsl
  (___bisect_post_visit___ 13 (List.length []))
  let _ =
  (___bisect_post_visit___ 14 (List.length [])) lsl
  (___bisect_post_visit___ 15 (List.length []))
  let _ =
  (___bisect_post_visit___ 16 (List.length [])) lsr
  (___bisect_post_visit___ 17 (List.length []))
  let _ =
  (___bisect_post_visit___ 18 (List.length [])) lsr
  (___bisect_post_visit___ 19 (List.length []))
  let _ =
  (___bisect_post_visit___ 20 (List.length [])) asr
  (___bisect_post_visit___ 21 (List.length []))
  let _ =
  (___bisect_post_visit___ 22 (List.length [])) asr
  (___bisect_post_visit___ 23 (List.length []))
  ...
  > EOF
  let _ = raise (___bisect_post_visit___ 0 (print_endline "foo"); Exit)
  let _ = raise_notrace (___bisect_post_visit___ 1 (print_endline "foo"); Exit)
  let _ = failwith (___bisect_post_visit___ 2 (print_endline "foo"); "bar")
