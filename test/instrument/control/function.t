...
Recursive instrumentation of cases.
  ...
  function
  | () ->
  (___bisect_visit___ 1; (function | () -> (___bisect_visit___ 0; ())))
...
Instrumentation suppressed "between arguments."
  ...
  > let _ = fun () -> function () -> ()
  > EOF
  let _ = fun () -> function | () -> (___bisect_visit___ 0; ())
...
Expressions in cases are in tail position.
  ...
  > EOF
  let _ = function | () -> (___bisect_visit___ 0; print_endline "foo")
...
Or-pattern.
  ...
  | None | Some _ ->
  ((((match ___bisect_matched_value___ with
  | None -> (___bisect_visit___ 0; ())
  | Some _ -> (___bisect_visit___ 1; ())
  | _ -> ()))
