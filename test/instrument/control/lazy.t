Thunk body is instrumented.
  ...
  > let _ = lazy (1 + 1)
  > EOF
  let _ = lazy (___bisect_visit___ 0; 1 + 1)
...
Recursive instrumentation of subexpression.
  ...
  > let _ = lazy (lazy (1 + 1))
  > EOF
  let _ = lazy (___bisect_visit___ 1; lazy ((___bisect_visit___ 0; 1 + 1)))
...
Trivial syntactic values are not instrumented.
  ...
  let _ = lazy None
  let _ = lazy Exit
  let _ = lazy (fun () -> ___bisect_visit___ 0; ())
  let _ = lazy (function | () -> (___bisect_visit___ 1; ()))
  let _ = lazy (() : unit)
  let _ = lazy (() :> unit)
  let x = 1 + 1
  let _ = lazy x
